...
metadata {
	definition (
		...
		fingerprint deviceId: "0001", inClusters: "0x31,0x60,0x86,0x72,0x85,0x84,0x80,0x70,0x20,0x71", mfr:"0060", prod:"0006"				
	}
...
private configSetCmd(param, val) {
	def configVal = convertFromScaledValue(val, param.size)
	return zwave.configurationV2.configurationSet(parameterNumber: param.num, size: param.size, configurationValue: configVal).format()
}
