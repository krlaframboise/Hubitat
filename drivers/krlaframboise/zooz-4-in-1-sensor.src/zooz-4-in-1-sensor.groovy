...
metadata {
	definition (
		...
		fingerprint deviceId: "2101", inClusters: "0x5E,0x86,0x72,0x5A,0x85,0x59,0x73,0x80,0x71,0x31,0x70,0x84,0x7A,0x98", outClusters: "", mfr:"027A", prod:"2021", deviceJoinName: "Zooz 4-in-1 Sensor"
		
		fingerprint deviceId: "2101", inClusters: "0x5E,0x86,0x72,0x5A,0x85,0x59,0x73,0x80,0x71,0x31,0x70,0x84,0x7A,0x98", outClusters: "", mfr:"0109", prod:"2021", deviceJoinName: "Zooz 4-in-1 Sensor"		
	}
...
private getFirmwareVersion() {
	return safeToDec(getDataValue("firmwareVersion"), 0.0)
}
...
def zwaveEvent(hubitat.zwave.commands.versionv1.VersionReport cmd) {
	...
	if (getDataValue("firmwareVersion") != "${version}") {
