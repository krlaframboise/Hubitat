...
metadata {
	definition (
		...
		fingerprint deviceId: "0087", inClusters: "0x5E,0x72,0x86,0x85,0x59,0x5A,0x73,0x70,0x25,0x27,0x71,0x32,0x20", outClusters: "", mfr:"021F", prod:"0003", deviceJoinName: "Dome On Off Plug"
	}
...
private configSetCmd(paramNum, val, size) {
	return zwave.configurationV1.configurationSet(parameterNumber: paramNum, size: size, configurationValue: intToHex(val, size)).format()
}
