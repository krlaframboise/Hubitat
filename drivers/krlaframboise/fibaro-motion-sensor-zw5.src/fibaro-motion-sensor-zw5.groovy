...
private getDriverDetails() { 
	return "<br>Fibaro Motion Sensor ZW5<br>Version 1.0.0<br>Supported Devices: FGMS-001 ZW5"
}
...
metadata {
	definition (
		...
		fingerprint deviceId: "2001", inClusters: "0x5E,0x20,0x86,0x72,0x5A,0x59,0x85,0x73,0x84,0x80,0x71,0x56,0x70,0x31,0x8E,0x22,0x30,0x9C,0x98,0x7A", outClusters: "", mfr:"010F", prod:"0801", deviceJoinName: "Fibaro Motion Sensor ZW5"
